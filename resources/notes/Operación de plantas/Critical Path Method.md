El Critical Path Method, o CPM, es un método de organizar proyectos basado en [PERT](PERT.md), donde el tiempo no es probabilístico – es decir, se encuentran bien definidos los tiempos.
