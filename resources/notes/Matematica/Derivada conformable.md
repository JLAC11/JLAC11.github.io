...
Para que la derivada conformable de Akkurt sea un *difeomorfismo*, se requiere que el mapeo $D^\alpha:\mathcal{f}\rightarrow\mathbb{R}$ sea invertible y diferenciable.
